...
#
# METIS Find Module for ADCIRC 
# Copied and adapted from open source code https://software.lanl.gov/ascem/trac
#
# Usage:
#    Control the search through METIS_ROOT to the METIS installation prefix.
#
...
# Metis sometimes puts the include files in a subdir called Lib
	...
	if(METIS_ROOT)
		...
		if (EXISTS "${METIS_ROOT}" )
		    ...
		    message("METIS_ROOT=${METIS_ROOT} does not exist")
                 set(METIS_INCLUDE_DIR "METIS_INCLUDE_DIR-NOTFOUND")
            endif()
